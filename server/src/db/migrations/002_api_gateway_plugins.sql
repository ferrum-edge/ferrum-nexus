...
--
-- A forward migration: an API published before it has no rows, which the
-- publishing service treats as "not yet recorded" (docs/operations.md,
...
CREATE TABLE IF NOT EXISTS api_gateway_plugins (
  ...
  ferrum_plugin_config_id TEXT NOT NULL,
