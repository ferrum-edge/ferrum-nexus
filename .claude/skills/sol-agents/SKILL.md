---
name: sol-agents
description: Dispatch and orchestrate GPT-6 Sol CLI subagents (low|medium|high|xhigh|max|ultra effort) for Ferrum Nexus issue, PR, review-feedback, CI-repair, and shepherding work. Use when the user asks Claude to delegate to GPT-6 Sol workers. Do not use when you are a dispatched worker or for ordinary single-agent edits.
---
