# Ferrum Nexus opencode continuation brief
...
`opus-agents`,
`fable-agents`, `.claude/skills/*/scripts/dispatch-agent.sh` (also reachable as
`.agents/skills/*/scripts/dispatch-agent.sh`), Codex CLI workers, or Claude CLI
