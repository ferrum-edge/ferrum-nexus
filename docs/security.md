...
| `api.credentials_invalidated` | `api`       | A confirmed `auth_plugin` change revoked the credentials it invalidated — the summary of the sweep whose individual revocations each wrote their own `credential.revoke` row. `details`: `previous_auth_plugin`, `auth_plugin`, `credential_type`, `stranded` (how many were in scope), `revoked` (how many actually came off), and `failed`/`failure_errors` naming the ones the gateway would not release. A non-empty `failed` is a portal row that still looks live for a key that no longer opens this API; alert on it. No row at all means the swap stranded nothing.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
