...
| `NEXUS_RATE_LIMIT_ENABLED`            | `true`                                       | Installs the 20 req/min limiter on `/api/auth/*` and the per-account messaging limiters on `/api/threads` (see [Abuse controls](#abuse-controls)). Forced off when `NEXUS_ENV=test`.                                                                                                                                                                                                                                                                                                                                                                     |
